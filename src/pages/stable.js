...
const StableModules = ({data}) => {
    return (
    <Layout pageTitle='Stable Training Modules'>
      <ol>
...
query {
  allTrainingModulesYaml(filter: {status: {eq: "stable"}}) {
    edges {
      node {
        description
        name
...
export const Head=() => <Seo title='Stable Training Modules'/>
export default StableModules